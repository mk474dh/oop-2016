 ...
 */
public class Door3 extends AbstractActor implements Openable {
    private Animation animation;
    private int on=0;

    public Door3(String name, boolean vertical) {
        super(name);
    ...
    public void open() {
        ...
        animation.start();
        animation.stopAt(3);
        getWorld().setWall(10,20,false);
    }

    public void close() {
        on=0;
        animation.stop();
        getWorld().setWall(10,20,true);
    }
